...
def main():
    ...
    ract = load_json("ract") or load_json("risk_ract")
    # clinical_performance and clinical_safety are deprecated inputs.
    # PMCF data should come from CER extraction. Load if present for
    # backwards compatibility but do not require them.
